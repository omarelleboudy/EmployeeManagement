    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorTitle = $"The {role.Name} role is in use.";
                    ViewBag.ErrorMessage = $"The {role.Name} role cannot be deleted " +
                        $"as there are users with this role assigned to them.";
                    return View("Error");
                }
            }
        }
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            var model = new EditUserViewModel
            {
                ...
                City = user.City,
                Claims = userClaims.Select(c => c.Type + ": " + (c.Type == c.Value ? "Yes" : "No")).ToList(),
                Roles = userRoles
            };
            return View(model);
        }
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role with the ID: {id} was not found";
                return View("NotFound");
            }
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role with the ID: {model.Id} was not found";
                return View("NotFound");
            }
            else
            {
        ...
        public async Task<IActionResult> EditUsersInRole(string roleId)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role with the ID: {roleId} was not found";
                return View("NotFound");
            }
